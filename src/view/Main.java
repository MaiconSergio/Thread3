...
public class Main extends JFrame {
	...
	public Main() {
		...
		Exec3 frogController = new Exec3(farol, lbFrog1, lbFrog2, lbFrog3, lbFrog4, lbFrog5, btnIniciar, textArea,lbFinish,textAreaFrog1,textAreaFrog2,textAreaFrog3,textAreaFrog4,textAreaFrog5);
